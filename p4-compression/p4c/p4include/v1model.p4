...
// CHANGED
extern void new_addr<T>(out T addr, in T anything);

extern void p4_logger<T>(in T variable);

extern void deflate_payload<T>(in varbit<11664> payload_in, in T payload_in_len, inout varbit<11664> payload_out, out T payload_out_len);

extern void inflate_payload<T>(in varbit<11664> payload_in, in T payload_in_len, inout varbit<11664> payload_out, out T payload_out_len);
