...
class V1Model : public ::Model::Model {
 protected:
    V1Model() :
            ...
            new_addr("new_addr"),
            p4_logger("p4_logger"),
            deflate_payload("deflate_payload"),
            inflate_payload("inflate_payload"),
 ...
 public:
    ...
    // CHANGED
    const ::Model::Elem       new_addr;
    const ::Model::Elem       p4_logger;
    const ::Model::Elem       deflate_payload;
    const ::Model::Elem       inflate_payload;
